    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4 py-4">
            <nav className="flex justify-between items-center">
              ...
              <div className="hidden md:flex space-x-8">
                <Link href="/" className="hover:border-b-2 hover:border-white transition-all">
                  Home
                </Link>
                <Link href="/about" className="hover:border-b-2 hover:border-white transition-all">
                  About
                </Link>
                <Link href="/dashboard" className="hover:border-b-2 hover:border-white transition-all">
                  Dashboard
                </Link>
                <Link href="/report" className="hover:border-b-2 hover:border-white transition-all">
                  Report
                </Link>
      ...
      <main className="flex-grow container mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Monitoring Dashboard</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-4">
              <ActivityItem type="new" id="12345" location="DKI Jakarta" time="5 minutes ago" />
              <ActivityItem type="resolved" id="12340" location="Jawa Barat" time="15 minutes ago" />
              <ActivityItem type="processing" id="12342" location="Jawa Timur" time="1 hour ago" />
            </div>

            <div className="mt-8 text-center">
              <h4 className="text-base font-medium mb-4">Specialize analytical features coming soon!</h4>
                ...
                <button className="flex items-center justify-center gap-2 border border-gray-300 bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-2 rounded-md transition-colors">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      strokeLinejoin="round"
                    />
                    <path d="M12 15V3" stroke="#4B5563" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path
                      d="M9 6L12 3L15 6"
                      stroke="#4B5563"
                      strokeWidth="2"
...
function ActivityItem({ type, id, location, time }: { type: string, id: string, location: string, time: string }) {
  const getIcon = () => {
    switch (type) {
      case "new":
        return (
...
function DonutChart() {
  return (
    <svg viewBox="0 0 100 100" className="w-full h-full">
      ...
      <path d="M50,10 A40,40 0 0,1 90,50 L50,50 Z" fill="#1D4ED8" /> {/* Blue */}
      <path d="M90,50 A40,40 0 0,1 50,90 L50,50 Z" fill="#10B981" /> {/* Green */}
      <path d="M50,90 A40,40 0 0,1 10,50 L50,50 Z" fill="#F59E0B" /> {/* Yellow */}
...
function BarChart() {
  return (
    <svg viewBox="0 0 500 200" className="w-full h-full">
      ...
      <line x1="40" y1="180" x2="480" y2="180" stroke="#E5E7EB" strokeWidth="1" />

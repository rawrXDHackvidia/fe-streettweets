  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Find your report ID on Street Tweets" />
      </Head>
        ...
        <main className="flex-grow">
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-3xl mx-auto">
              <h1 className="text-3xl font-bold text-center mb-12">Find Your Report ID</h1>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-12">
                <div className="flex gap-2">
                  ...
                  />
                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md">Find</button>
                </div>
              </div>

              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-center text-blue-600 mb-6">Recent Report Updates</h2>
                ...
                <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
                  ...
                  <div className="mt-1 text-sm text-gray-600">
                    ...
                    <span className="text-gray-400 text-xs">11 minutes ago</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
                  ...
                  <div className="mt-1 text-sm text-gray-600">
                    ...
                    <span className="text-gray-400 text-xs">22 minutes ago</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-sm opacity-80 mb-4">
                  ...
                  sed. Nibh est sit lobortis id tempor.
                </p>
